...
@WebSocketGateway({cors:{origin:['https://performasync.netlify.app','https://piprojectdeploy.onrender.com','https://hoppscotch.io','http://localhost:4200','http://localhost:3000']}})
